...
public class SimpleClassReflectionTest extends AbstractReflectionTest {
    @Override
    ...
    public String getExpectedStringRepresentation() {
        return "com.github.zerkseez.reflection.types.SimpleClass";
    }
