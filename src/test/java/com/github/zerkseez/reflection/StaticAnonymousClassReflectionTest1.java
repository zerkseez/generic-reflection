...
public class StaticAnonymousClassReflectionTest1 extends AbstractReflectionTest {
    private static final GenericInterface<?> TEST_SUBJECT;
    
    static {
        TEST_SUBJECT = new GenericInterface<Short>() {
            @Override
            public Short getT() {
                return null;
            }
    ...
    public String getExpectedStringRepresentation() {
        return "com.github.zerkseez.reflection.StaticAnonymousClassReflectionTest1$1";
    }
