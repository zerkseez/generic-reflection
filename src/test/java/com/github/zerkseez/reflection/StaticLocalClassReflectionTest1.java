...
public class StaticLocalClassReflectionTest1 extends AbstractReflectionTest {
    private static final GenericInterface<?> TEST_SUBJECT;
    
    static {
        class LocalClass implements GenericInterface<Short> {
            @Override
            public Short getT() {
                return null;
            }
        ...
        TEST_SUBJECT = new LocalClass();
    }
    
    @Override
    public Class<?> getType() {
        return TEST_SUBJECT.getClass();
    }

    @Override
    public String getExpectedStringRepresentation() {
        return "com.github.zerkseez.reflection.StaticLocalClassReflectionTest1$1LocalClass";
    }
