...
public class GenericLocalClassReflectionTest3 extends AbstractReflectionTest {
    private static <T extends SimpleInterface> GenericInterface<?> getTestSubject() {
    ...
    public String getExpectedStringRepresentation() {
        return "com.github.zerkseez.reflection.GenericLocalClassReflectionTest3$1LocalClass";
    }
