...
public class SimpleInterfaceReflectionTest extends AbstractReflectionTest {
    @Override
    ...
    public String getExpectedStringRepresentation() {
        return "com.github.zerkseez.reflection.types.SimpleInterface";
    }
    ...
    public Collection<String> getExpectedPublicMethods() {
        return Arrays.asList(
                "public abstract java.lang.Object doSimpleOperation()"
        );
    }
