...
public class GenericAnonymousClassReflectionTest3 extends AbstractReflectionTest {
    ...
    public String getExpectedStringRepresentation() {
        return "com.github.zerkseez.reflection.GenericAnonymousClassReflectionTest3$1";
    }
