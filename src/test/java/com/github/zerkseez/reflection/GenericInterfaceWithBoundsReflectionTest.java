...
public class GenericInterfaceWithBoundsReflectionTest extends AbstractReflectionTest {
    @Override
    ...
    public String getExpectedStringRepresentation() {
        return "com.github.zerkseez.reflection.types.GenericInterfaceWithBounds<T extends com.github.zerkseez.reflection.types.SimpleInterface>";
    }
    ...
    public Collection<String> getExpectedTypeVariables() {
        return Arrays.asList("T extends com.github.zerkseez.reflection.types.SimpleInterface");
    }
}
