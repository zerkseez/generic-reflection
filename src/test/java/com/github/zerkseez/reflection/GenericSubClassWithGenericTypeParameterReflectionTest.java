...
import com.github.zerkseez.reflection.types.GenericSubClassWithGenericTypeParameter;

public class GenericSubClassWithGenericTypeParameterReflectionTest extends AbstractReflectionTest {
    @Override
    public Class<?> getType() {
        return GenericSubClassWithGenericTypeParameter.class;
    }

    @Override
    public String getExpectedStringRepresentation() {
        return "com.github.zerkseez.reflection.types.GenericSubClassWithGenericTypeParameter<T>";
    }
    ...
    public Collection<String> getExpectedPublicConstructors() {
        return Arrays.asList(
                "public GenericSubClassWithGenericTypeParameter()"
        );
    }
