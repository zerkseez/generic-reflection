...
import com.github.zerkseez.reflection.types.GenericInterfaceWithDefaultFunction;

public class GenericInterfaceWithDefaultFunctionReflectionTest extends AbstractReflectionTest {
    @Override
    public Class<?> getType() {
        return GenericInterfaceWithDefaultFunction.class;
    }

    @Override
    public String getExpectedStringRepresentation() {
        return "com.github.zerkseez.reflection.types.GenericInterfaceWithDefaultFunction<A, B>";
    }
    ...
    public Collection<String> getExpectedPublicMethods() {
        return Arrays.asList(
                "public A getA()",
                "public java.util.List<B> getListOfB()"
        );
    }
